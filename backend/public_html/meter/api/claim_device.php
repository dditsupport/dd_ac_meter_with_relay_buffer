<?php
// POST /meter/api/claim_device.php
...
// location is a WorkPulse locations.location_id (int), or null.
$location     = ($body['location'] ?? '') === '' ? null : (int)$body['location'];
